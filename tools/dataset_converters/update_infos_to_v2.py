...
def update_nuscenes_infos(pkl_path, out_dir):
    ...
    nusc = NuScenes(
        ...
        dataroot = '/home/tsing-adept/datasets/nuScenes',
        verbose=True)
...
def update_4d_infos(pkl_path, out_dir):
    print(f'{pkl_path} will be modified.')
    if out_dir in pkl_path:
        print(f'Warning, you may overwriting '
              f'the original data {pkl_path}.')
...
def update_pkl_infos(dataset, out_dir, pkl_path):
    ...
    elif dataset.lower() == '4d':
        update_4d_infos(pkl_path=pkl_path, out_dir=out_dir)
