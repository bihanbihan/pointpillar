_base_ = [
    ...
    '../_base_/models/pointpillars_hv_secfpn_4D_Radar.py',
    # '../_base_/datasets/kitti-3d-3class.py',
    '../_base_/datasets/radar-3d-5class.py',
...
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + '4D_dataset_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
        filter_by_difficulty=[-1],
        # filter_by_min_points=dict(Car=5, Pedestrian=5, Cyclist=5, Truck=5, Bus=5)),
        filter_by_min_points=dict(Car=5, Pedestrian=5, Cyclist=5, Bus=5)),
    classes=class_names,
    # sample_groups=dict(Car=15, Pedestrian=15, Cyclist=15, Truck=15, Bus=15),
    sample_groups=dict(Car=15, Pedestrian=15, Cyclist=15, Bus=15),
    points_loader=dict(
